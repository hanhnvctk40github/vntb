...
bộ Công an,đối thoại,Đồng Tâm 9/1/2020,Đồng Tâm,Hữu Sự,minh bạch,trấn áp tinh thần,Trịnh Bá Phương,cụ Lê Đình Kình,đất quốc phòng">
    ...
    <link rel="alternate" type="application/rss+xml" href="/feed/" title="Tin Tức An Nam latest posts">
    <link rel="alternate" type="application/rss+xml" href="/comments/feed/" title="Tin Tức An Nam latest comments">
    <link rel="pingback" href="/xmlrpc.php">

    <title>Tin Tức An Nam – {{ isset($title) && $title ? $title : 'Tin tức trung thực, phản biện không ngừng' }}
    </title>
    <style>
    ...
    <link rel="stylesheet" id="wp-block-library-css" href="{{ asset('assets/style.min.css') }}" type="text/css"
        media="all">
    <link rel="stylesheet" id="tds-style-frontend-css" href="{{ asset('assets/style-front.min.css') }}" type="text/css"
        media="all">
    <link rel="stylesheet" id="wordpress-popular-posts-css-css" href="{{ asset('assets/wpp.css') }}" type="text/css"
        media="all">
    <link rel="stylesheet" id="novomag-style-css" href="{{ asset('assets/main-stylesheet.css') }}" type="text/css"
        media="all">
    ...
    <link rel="stylesheet" id="main-stylesheet-css" href="{{ asset('assets/main-stylesheet(1).css') }}" type="text/css"
        media="all">
    <link rel="stylesheet" id="lightbox-css" href="{{ asset('assets/lightbox.css') }}" type="text/css" media="all">
    <link rel="stylesheet" id="shortcodes-css" href="{{ asset('assets/shortcodes.css') }}" type="text/css"
        media="all">
    <link rel="stylesheet" id="owl-carousel-css" href="{{ asset('assets/owl.carousel.css') }}" type="text/css"
        media="all">
    <link rel="stylesheet" id="responsive-css" href="{{ asset('assets/responsive.css') }}" type="text/css"
        media="all">
...
<![endif]-->
    <link rel="stylesheet" id="style-css" href="{{ asset('assets/style(1).css') }}" type="text/css"
        media="all">
    ...
    <link rel="alternate" type="application/rss+xml" title="RSS"
        href="https://vietnamthoibao.org/rsslatest.xml" />
    <style type="text/css" id="wp-custom-css">
        .main-menu ul.menu>li ul.sub-menu>li>a,
        .main-menu ul.menu>li>a {
            color: #444;
    ...
    <meta property="og:site_name" content="Tin Tức An Nam">
    <meta property="og:title" content="Tin Tức An Nam">
...
<body
    class="home page-template page-template-template-homepage page-template-template-homepage-php page page-id-37286 unselectable"
                ...
                <div class="wrapper">
                    <ul class="le-first">
                        ...
                        <li id="menu-item-3335"
                            class="menu-item menu-item-type-custom menu-item-object-custom single"><a
                                href="/latest">Chuyên Mục</a></li>
                        <li id="menu-item-28227"
                            class="menu-item menu-item-type-post_type menu-item-object-page single"><a
                                href="/lien-lac/">Liên Lạc</a></li>
                        <li id="menu-item-28232"
                            class="menu-item menu-item-type-post_type menu-item-object-page single"><a
                                href="/huong-dan-gui-bai/">Hướng dẫn gửi bài</a></li>
                        <li id="menu-item-18447"
                            class="menu-item menu-item-type-taxonomy menu-item-object-category single"><a
                                href="/category/english-only/">English only</a></li>
                    </ul> <!-- END .wrapper -->
            ...
            <div class="wrapper">
                ...
                <div class="header-block">
                    <div class="header-logo">
                        <a href="/"><img src="{{ asset('assets/images/bg.png') }}" /></a>
                    </div>
                ...
                <div class="wrapper">
                    ...
                    <ul class="menu menu" rel="Main Menu">
                        <li id="menu-item-28221"
                            class="normal-drop  menu-single menu-item menu-item-type-custom menu-item-object-custom"><a
                                href="/">Home</a></li>
                        <li id="menu-item-1467"
                            class="normal-drop menu-item menu-item-type-taxonomy menu-item-object-category"><a
                                href="/" style="border-bottom: 3px solid #214a82; ">Tin mới</a></li>
                        <li id="menu-item-1474"
                            class="normal-drop menu-item menu-item-type-taxonomy menu-item-object-category"><a
                                href="/" style="border-bottom: 3px solid #214a82; ">Đối Diện</a></li>
                        <li id="menu-item-1491"
                            class="normal-drop menu-item menu-item-type-taxonomy menu-item-object-category"><a
                                href="/" style="border-bottom: 3px solid #214a82; ">Diễn Đàn</a></li>
                        <li id="menu-item-1469"
                            class="normal-drop menu-item menu-item-type-taxonomy menu-item-object-category"><a
                                href="/" style="border-bottom: 3px solid #214a82; ">Dân Chủ</a></li>
                        <li id="menu-item-20508"
                            class="normal-drop  menu-single menu-item menu-item-type-taxonomy menu-item-object-category">
                            <a href="/" style="border-bottom: 3px solid #033567; ">Chính Trị</a></li>
                        <li id="menu-item-1470"
                            class="normal-drop menu-item menu-item-type-taxonomy menu-item-object-category"><a
                                href="/" style="border-bottom: 3px solid #214a82; ">Kinh tế</a></li>
                        <li id="menu-item-1471"
                            class="normal-drop menu-item menu-item-type-taxonomy menu-item-object-category"><a
                                href="/" style="border-bottom: 3px solid #214a82; ">Xã hội</a></li>
                        <li id="menu-item-1454"
                            class="normal-drop menu-item menu-item-type-taxonomy menu-item-object-category"><a
                                href="/" style="border-bottom: 3px solid #214a82; ">Thế Giới</a></li>
                        <li id="menu-item-1472"
                            class="normal-drop menu-item menu-item-type-taxonomy menu-item-object-category"><a
                                href="/" style="border-bottom: 3px solid #214a82; ">Về Hội</a></li>
                    </ul> <!-- END .wrapper -->
                    <a href="#" class="toggle-menu"><i class="fa fa-bars"></i> Toggle Menu</a>
                </div>
                            ...
                            <ul style="left: -1364px;">
                                @if (isset($mostReadArticles) && $mostReadArticles)
                                    @foreach ($mostReadArticles as $article)
                                        <li>
                                            <h4><a
                                                    href="{{ asset('bai-viet/' . $article->id . '/' . $article->seo_title) }}">{{ $article->title }}</a>
                                            </h4><i class="fa fa-exclamation"></i>
                                        </li>
                                    @endforeach
                                @endif
                            </ul>
                ...
                <aside id="sidebar" class="right" style="height: auto; min-height: 3763.11px;">
                    <div class="widget_text widget-1 first widget">
                        ...
                        <div class="textwidget custom-html-widget">
                            <a href="{{ route('login') }}" style="display: block; margin-top: 30px"><img
                                    src="{{ asset('assets/member.jpg') }}" /></a>
                        </div>
                    </div>
                                        ...
                                        <div class="item">
                                            <a href='{{ asset('bai-viet/' . $article->id . '/' . $article->seo_title) }}'>
                                                <img src="{{ asset('assets/upload/article/' . $article->background_image) }}"
                                                    class="item-photo litespeed-loaded" /></a>
        ...
        <footer class="footer">
            ...
            <div class="wrapper">
                ...
                <div class="footer-widgets">
                    ...
                    <div class="widget_text widget-1 first widget">
                        ...
                        <div class="textwidget custom-html-widget">
                            <p>
                                Trang tạp chí điện tử Tin Tức An Nam<br>
                                Tạp chí điện tử Người đưa tin<br>
                                Cơ quan chủ quản: Hội Người đưa tin An Nam<br>
                                Tổng biên tập: Trần Văn An Nam
                            </p>
                        </div>
                    </div>
            ...
            <div class="footer-bottom">
                ...
                <div class="wrapper">
                    ...
                    <p class="left">Copyright 2023 - Bản quyền thuộc Tạp chí điện tử Tin Tức An Nam<a href="/" target="_blank"></a></p>
    ...
    <div class="lightbox">
        <div class="lightcontent-loading">
            <a href="/#" onclick="javascript:lightboxclose();" class="light-close"><i
                    class="fa fa-minus-square"></i>&nbsp;&nbsp;Close Window</a>
    ...
    <script>
        ...
        function themesAutoLoad() {
            var thenextpage = (jQuery(".slider > .slider-navigation > li.active").next().index() == "-1") ? 0 : jQuery(
                ".slider > .slider-navigation > li.active").next().index();
            setTimeout(function() {
                if (_otSliderAuto) {
        ...
        function themesLoadPage(num) {
            ...
            jQuery(".slider > .slider-navigation > li").eq(num).addClass("active").siblings(".active").removeClass(
            "active");
            _otSliderCurrentPage = num + 1;
        }
    </script>

    <a rel="nofollow" style="display:none;" href="/?blackhole=f23b16e4ff"
        title="Do NOT follow this link or you will be banned from the site!">Tin Tức An Nam</a>
    <div id="wpcp-error-message" class="msgmsg-box-wpcp warning-wpcp hideme"><span>Alert: </span>You are not allowed
        to copy content or view source</div>
    <script>
        var timeout_result;
    ...
    <link rel="stylesheet" id="yarppRelatedCss-css" href="{{ asset('assets/related.css') }}" type="text/css"
        media="all">
    ...
    <script type="text/javascript" src="{{ asset('assets/jquery.floating_popup.1.3.min.js.download') }}" id="banner-js">
    </script>
    <script type="text/javascript" src="{{ asset('assets/theme-scripts.js.download') }}"
        id="/wp-content/themes/novomag-theme/js/-scripts-js"></script>
    <script type="text/javascript" src="{{ asset('assets/lightbox.js.download') }}" id="lightbox-js"></script>
    <script type="text/javascript" src="{{ asset('assets/jquery.infinitescroll.min.js.download') }}"
    ...
    <script type="text/javascript" src="{{ asset('assets/jquery.nicescroll.min.js.download') }}" id="nicescroll-js">
    </script>
